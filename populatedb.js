...
async function createMessages () {
  ...
  await Promise.all([
    messageCreate(0, '1st Message', "Hi, I'm not JAck", users[0]),
    messageCreate(1, '2nd Message', 'Yo! Who you calling Jack!!!?', users[1]),
    messageCreate(2, "Don't fight", "Hey guys, don't fight", users[3]),
    messageCreate(
      3,
    ...
    messageCreate(7, 'Sorry', 'I was just kidding, I love you Jack', users[0]),
    messageCreate(8, 'Sorry', 'Love you too Jill', users[1]),
    messageCreate(9, 'LMAO', "Ya'll wild!", users[3])
  ])
}
